...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SuperHeroes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11SuperHeroes11AppDelegate")
...
SWIFT_CLASS("_TtC11SuperHeroes13SceneDelegate")
...
SWIFT_CLASS("_TtC11SuperHeroes14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(SuperHeroes)) <UITableViewDataSource>
